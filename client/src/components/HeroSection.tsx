    ...
    <section className="relative bg-[#3498db] text-white">
      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-6xl font-bold font-poppins mb-6">Deconotes</h1>
          <p className="text-xl md:text-2xl mb-8">Soluciones innovadoras para un mejor mañana</p>
